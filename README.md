# 👋 Hey there! I'm Aadarsh Shrivastava

Welcome to my GitHub profile! I'm a passionate **MERN Stack Developer** with a strong foundation in **Data Structures and Algorithms (DSA)**. I love building scalable, user-friendly web applications and solving complex problems.

---

## 💫 About Me

I'm dedicated to crafting robust, efficient, and impactful software solutions. With expertise across the full MERN stack, I specialize in:

- 🎨 **Frontend Development** – Creating responsive, intuitive interfaces with React and Bootstrap
- 🔧 **Backend Development** – Building secure, scalable APIs with Node.js, Express.js, and MongoDB
- 📊 **Database Design** – Architecting efficient databases and optimizing queries
- 🔌 **API Integration** – Seamlessly connecting frontend and backend systems
- 🧠 **Problem Solving** – Applying DSA principles to solve complex challenges
